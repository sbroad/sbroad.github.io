(function ($) {
    var CarouselEvo = function (element, options) {
        ...
        var slideItems = carousel.children('.slideItem'),
            slideImage = slideItems.find('.Slideimg'),
	   slideImageCont = slideImage.find('img'),
            currentSlide = 0,
            targetSlide = 0,
	 ...
	 var setImageSizeMax = function (p) {
            var o = settings,
                n = numberSlides,
                w = o.frontWidth,
                h = o.frontHeight,
		...
		slideImageCont.eq(i).css(setImageSizeMax(slidePos(i)));
	    ...
	    slideImageCont.eq(i).animate(setImageSizeMax(pos), o.speed, 'linear');
            if (o.reflection == true) {
